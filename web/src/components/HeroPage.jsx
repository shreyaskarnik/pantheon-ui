    ...
    <div className="hero">
      <div className="hero-content">
        ...
        <p className="hero-description">
          Inspired by <a href="https://en.wikipedia.org/wiki/Pantheon_(TV_series)" target="_blank" rel="noopener" className="hero-link">Pantheon</a>. 100% client-side. 100% nerd.<br />
